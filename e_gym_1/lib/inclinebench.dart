...
class InclineBench extends StatelessWidget {
            ...
            children: [
              ...
              Stack(children: <Widget>[
                ...
                Positioned(
                  ...
                  left: 48,
                  child: Image(
                    image: AssetImage('assets/inclinebench.png'),
                    width: 250,
                  ),
                ),
              ]),
...
class _MyWebViewState extends State<MyWebView> {
  ...
  void initState() {
    _webViewController = WebViewController()
      ..loadRequest(Uri.parse('https://www.youtube.com/watch?v=DUary1hEAfE&t=143s'))
